                        ...
                        <form action="" name="updateUserForm" id="updateUserForm">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" value="{{ $user->designation }}" placeholder="Designation" id="designation" name="designation" class="form-control">
                                </div>  
                            
                                <div class="col-md-6 mb-4">
                                    <label for="mobile" class="form-label">Mobile</label>
                                    <input type="text" value="{{ $user->mobile }}" placeholder="Mobile" id="mobile" name="mobile" class="form-control">
                                </div> 
