                ...
                <div class="col">
                    <nav aria-label="breadcrumb" class=" rounded-3 p-3 mb-4">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('account.myjobs')}}">My Job</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6  mb-4">
                                ...
                                <select name="category_id" id="category" class="form-select">
                                    ...
                                    <option {{$job->category_id==$categoriy->id?'selected':''}} value="{{$categoriy->id}}">{{$categoriy->name}}</option>
                                    @endforeach
                                @endif
                                </select>
                                <p></p>
...
<script>
    ...
    $.ajax({
        url: '{{ route("account.job_update",$job->id) }}',
        type: 'post',
